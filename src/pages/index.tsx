...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Head>
        <title>Naible - Personal Intelligence</title>
        <meta name="description" content="A private, evolving AI that's 100% yours—trained on your data, serving your needs, and controlled by you alone." />
